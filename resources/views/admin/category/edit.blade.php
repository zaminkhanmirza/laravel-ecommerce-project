...
<section class="content">
    ...
    <div class="container-fluid">
        <form action="javascript:void(0)" method="post" id="categoryFormId" name="categoryForm">
            @csrf
        <div class="card">
            <div class="card-body">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        @if (!empty(@$category->image))
                            <img src="{{ asset('uploads/category/'.@$category->image) }}" alt="" width="400">
                        @endif
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
...
@section('customJs')
<script>
    $("#categoryFormId").submit(function(event) { 
